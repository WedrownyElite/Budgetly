...
class SubscriptionsScreen extends StatefulWidget {
  ...
  const SubscriptionsScreen({super.key, required this.transactions});
...
class _SubscriptionsScreenState extends State<SubscriptionsScreen> {
  ...
  double _getTotalAnnualCost(SubscriptionStatus? filterStatus) {
    return _managedSubscriptions
        .where((s) => filterStatus == null || s.status == filterStatus)
        .fold(0.0, (sum, s) => sum + s.recurringTransaction.annualCost);
  }
          ...
          Row(
            children: [
              ...
              Expanded(
                child: _buildSummaryCard(
                  'Annual Cost',
                  _getTotalAnnualCost(SubscriptionStatus.active),
                  Colors.purple,
                    ...
                    Row(
                      children: [
                        ...
                        if (managed.nextBillingDate != null) ...[
                          ...
                          Flexible(
                            child: Text(
                              'Next: ${managed.nextBillingDate!.month}/${managed.nextBillingDate!.day}/${managed.nextBillingDate!.year}',
                              style: TextStyle(
                                fontSize: 11,
                                color: isDark ? Colors.white60 : Colors.grey[600],
                              ),
...
class _ManageSubscriptionDialogState extends State<_ManageSubscriptionDialog> {
  ...
  void initState() {
    ...
    if (widget.existing != null) {
      ...
      // Estimate next billing date based on last transaction
